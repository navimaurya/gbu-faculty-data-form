                               ...
                               <h4><input  class="form-control"  type="text" name="position" placeholder="Position e.g Assistant Professor (Department of ...?..)" value="<?php echo $position;?>"></h4>
                                <h6>
									...
									<select class="form-control" name="school">
										...
										<option value="University School Of Information And Communication Technology" <?php if ($school == 'University School Of Information And Communication Technology') { echo 'selected';} ?>>University School of Information & Communication Technology</option>
